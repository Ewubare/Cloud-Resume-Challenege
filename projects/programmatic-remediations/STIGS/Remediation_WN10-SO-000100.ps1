<#
.SYNOPSIS
    This PowerShell script configures the Windows SMB client to always perform SMB packet signing to comply with STIG requirements.
...
Write-Output "Remediating: WN10-SO-000100 - The Windows SMB client must be configured to always perform SMB packet signing..."

try {
    # Set the RequireSecuritySignature registry value to enable SMB client packet signing
