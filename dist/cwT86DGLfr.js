...
async function updateVisitorCount() {
    try {
        const response = await fetch('https://o7v81iwquc.execute-api.us-east-1.amazonaws.com/prod/visitor-count', {
            method: 'POST',
            headers: {
        ...
        // Parse the body field which contains the actual count data
        const bodyData = JSON.parse(data.body);
        document.getElementById('counter').textContent = bodyData.count;
